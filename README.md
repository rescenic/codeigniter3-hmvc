...
CodeIgniter 3.1.13 with HMVC (With PHP backward functions for each() and list() and code optimisations), Whoops Error Handling Framework and Support PHP 8.3
...
All MY_extension libraries should include (require) their equivalent MX library file and extend their equivalent MX_ class
